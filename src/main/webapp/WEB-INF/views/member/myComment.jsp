...
<style>
		...
		#table th.comment {width: 15%; margin:auto;}
		 #table th.title {width: 15%; margin:auto;} 
		#table th.date {width: 10%; border-radius: 0 20px 20px 0;}
		/* tbody */
		#table tbody td {padding: 10px 0; border-bottom: 1px solid #373B44;}
		/* title 열의 내용은 좌측 정렬 */
		#table tbody td.listTitle {text-align: center;}
		/* 
		    - 2줄 이상은 ... 으로 표시
