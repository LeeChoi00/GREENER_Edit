...
<div class="col-md-12">
	<div class="input">
		  <input type="button" value="이메일로 아이디 찾기" class="inputBtn" onclick="location.href='<%=request.getContextPath() %>/searchIdByEmailForm.me'"><br>
		  <input type="button" value="전화번호로 아이디 찾기" class="inputBtn" onclick="location.href='<%=request.getContextPath() %>/searchIdByPhoneForm.me'">
	</div>
</div>
